(function (blink) {
	...
	var maristas_demoStyle = function () {
			blink.theme.styles.basic.apply(this, arguments);
		},
		page = blink.currentPage;

	maristas_demoStyle.prototype = {
		//BK-15873 añadimos el estilo basic como parent para la herencia de los estilos del CKEditor
		parent: blink.theme.styles.basic.prototype,
		bodyClassName: 'content_type_clase_maristas_demo',
		extraPlugins: ['image2'],
		ckEditorStyles: {
			name: 'maristas_demo',
			styles: [
	...
	maristas_demoStyle.prototype = _.extend({}, new blink.theme.styles.basic(), maristas_demoStyle.prototype);

	blink.theme.styles.maristas_demo = maristas_demoStyle;
...
$(document).ready(function () {
	...
	var src_logo = $('.content_type_clase_maristas_demo').find('.logo_slide').attr('logo_dominio');
